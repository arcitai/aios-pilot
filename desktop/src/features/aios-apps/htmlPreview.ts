...
*{box-sizing:border-box}body{margin:0;background:#eceeea;color:#20231e;font:16px/1.5 Inter,system-ui,sans-serif}section{position:relative;display:flex;flex-direction:column;justify-content:center;width:min(100% - 48px,1100px);min-height:min(62vw,640px);margin:32px auto;padding:8%;border:1px solid #d7dad3;border-radius:18px;background:#fafbf8;box-shadow:0 10px 40px #20231e12}span{color:#73796d;font-size:12px;font-weight:700;letter-spacing:.16em}h1{max-width:840px;margin:28px 0 16px;font-size:clamp(40px,7vw,88px);line-height:1.02;letter-spacing:-.055em}p{max-width:720px;color:#565c52;font-size:clamp(18px,2.4vw,27px);white-space:normal}@media print{body{background:white}section{width:100%;min-height:100vh;margin:0;border:0;border-radius:0;box-shadow:none;break-after:page}}
